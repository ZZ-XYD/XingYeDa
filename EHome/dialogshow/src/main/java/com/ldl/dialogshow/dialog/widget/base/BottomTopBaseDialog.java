package com.ldl.dialogshow.dialog.widget.base;
...
public abstract class BottomTopBaseDialog<T extends BottomTopBaseDialog<T>> extends BaseDialog<T> {
    ...
    /** set duration for inner com.lidalong.dialogshow.animation of mAnimateView(设置animateView内置动画时长) */
    ...
    /** show dialog and mAnimateView with inner show com.lidalong.dialogshow.animation(设置dialog和animateView显示动画) */
    ...
    /** dimiss dialog and mAnimateView with inner dismiss com.lidalong.dialogshow.animation(设置dialog和animateView消失动画) */
