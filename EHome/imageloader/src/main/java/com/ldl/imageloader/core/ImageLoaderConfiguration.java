 ...
 *******************************************************************************/
package com.ldl.imageloader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;

import com.ldl.imageloader.cache.disc.DiskCache;
import com.ldl.imageloader.cache.disc.naming.FileNameGenerator;
import com.ldl.imageloader.cache.memory.MemoryCache;
import com.ldl.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.ldl.imageloader.core.assist.FlushedInputStream;
import com.ldl.imageloader.core.assist.ImageSize;
import com.ldl.imageloader.core.assist.QueueProcessingType;
import com.ldl.imageloader.core.decode.ImageDecoder;
import com.ldl.imageloader.core.download.ImageDownloader;
import com.ldl.imageloader.core.process.BitmapProcessor;
import com.ldl.imageloader.utils.L;
import com.ldl.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.ldl.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.ldl.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.ldl.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.ldl.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.ldl.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.ldl.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.ldl.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.ldl.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.ldl.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.ldl.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.ldl.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.ldl.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.ldl.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.ldl.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
