...
public final class JVNetConst {
    ...
    public final static int JVN_SD_STORAGE = 7;//SD卡数据
    ...
    public final static int SRC_PARAM_ALL = 0x02;
    public final static int SRC_TIME = 0x03;
    public final static int SRC_CHAT = 0x04;
    public final static int SRC_FIRMUP = 0x05;
    public final static int SRC_STORAGE = 0x06;
    public final static int SRC_DISPLAY = 0x07;
    public final static int SRC_INTELLIGENCE = 0x08;
    public final static int SRC_ABOUTEYE = 0x09;
    public final static int SRC_REMOTE_PLAY = 0x10;
    public final static int SRC_REMOTE_DOWNLOAD = 0x11;
    public final static int SRC_REMOTE_CHECK = 0x12;
    public final static int SRC_REMOTE_CMD = 0x13;



    //gSRemotecfg->packet.nPacketType
    ...
    public final static byte SRC_EX_FIRMUP_START = 0x05;
    ...
    //extend->nParam
    public final static int FIRMUP_FTP = 0x02;
    public final static int FIRMUP_HTTP = 0x00;
    public final static int FIRMUP_FILE = 0x01;
    public final static int FIRMUP_SUCCESS = 0x01;
    public final static int FIRMUP_FAILED = 0x02;
    public final static int FIRMUP_LATEST = 0x03;
    public final static int FIRMUP_INVALID = 0x04;
    public final static int FIRMUP_ERROR = 0x05;
    public final static int FIRMUP_NOTFIT = 0x06;




    //回调what
    public static final int CALL_CATEYE_SENDDATA = 0xD6;


    //猫眼流媒体视频连接结果
    public static final int CALL_CATEYE_ADDRESS = 0xD1;//Jni.strMedAddress的回调
    public static final int CALL_CATEYE_ONLINE = 0xD2;//Jni.strMedOnline的回调
    public static final int CALL_CATEYE_CONNECTED = 0xD3;//视频连接成功
    public static final int CALL_CATEYE_DISCONNECTED = 0xD5;//视频断开
    public static final int CALL_NEW_PICTURE = 0xA9;//I帧


    //流媒体猫眼下载回调
    public static final int CALL_CATEYE_DOWNLOAD = 0xD7;
    public static final int CALL_CATEYE_DOWNLOADFINISHED = 0xD8;

    public static final int DT_FILE_HEAD = 6;
    public static final int DT_FILE_DATA = 7;
    public static final int DT_FILE_TAIL = 8;

    public static final int DOWN_SUCCESS = 1;//下载成功


    public static final int CALL_CATEYE_SEARCH_DEVICE = 0xD9;//猫眼流媒体广播回调
    public static final int CALL_CATEYE_PLAY = 0xDA;//猫眼流媒体 远程回放播放数据回调
    public static final int CALL_CATEYE_RECEIVED = 0xD4;//猫眼流媒体 实时视频播放O帧数据回调
