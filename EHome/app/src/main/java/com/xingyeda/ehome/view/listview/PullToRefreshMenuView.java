package com.xingyeda.ehome.view.listview;
...
import com.xingyeda.ehome.view.listview.FooterLoadingLayout;
import com.xingyeda.ehome.view.listview.ILoadingLayout;
import com.xingyeda.ehome.view.listview.LoadingLayout;
...
public class PullToRefreshMenuView extends PullToRefreshBase<SwipeMenuListView> implements OnScrollListener {
    ...
    protected SwipeMenuListView createRefreshableView(Context context, AttributeSet attrs) {
     ...
     //   mListView.setDivider(getResources().getDrawable(R.drawable.shape_divider_default));
        ...
        listView.setDivider(getResources().getDrawable(R.color.lucency_grey));
