package com.xingyeda.ehome.assist;
...
public class Shortcut {
    ...
    public static void createShortCut(Context context) {
        ...
        Shortcut.addShortcut(context,"一键开门",intent, Intent.ShortcutIconResource.fromContext(context, R.mipmap.open_the_door) ,false);
     ...
     * @param context
     * @param name  快捷方式名字
     * @param actionIntent  快捷方式的操作
     * @param icon  快捷方式的图标
     * @param allowRepeat  是否允许重复生成
     */
    public static void addShortcut(Context context, String name, Intent actionIntent, Intent.ShortcutIconResource icon, boolean allowRepeat){
     ...
     * @param allowRepeat  是否允许重复生成
     */
    public static void addShortcut(Context context, String name, Intent actionIntent, Bitmap icon, boolean allowRepeat){
     ...
     * @param name  快捷方式的名字
     * @param actionIntent  快捷方式的操作
     * @param allowRepeat  为ture时循环删除快捷方式（即存在很多一样的快捷方式）
     */
    public static void deleteShortcut(Context context, String name, Intent actionIntent, boolean allowRepeat){

        Intent shortcutIntent = new Intent("com.android.launcher.action.UNINSTALL_SHORTCUT");
        shortcutIntent.putExtra("duplicate", allowRepeat);//是否循环删除，比如有很多一样的快捷方式
        shortcutIntent.putExtra(Intent.EXTRA_SHORTCUT_NAME, name);//快捷方式的标题
        shortcutIntent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, actionIntent);//快捷方式的动作
        context.sendBroadcast(shortcutIntent);//发送广播
    }
...
//        if(bitmap==null){
//            LogUtils.i("update shortcut icon,bitmap empty");
//            return;
//        }
//        try{
...
//                LogUtils.i("update ok: affected "+i+" rows,index is"+index);
//            }else{
//                LogUtils.i("update result failed");
//            }
...
//        }catch(Exception ex){
//            ex.printStackTrace();
//            LogUtils.i("update shortcut icon,get errors:"+ex.getMessage());
//        }
//    }
//
//
...
//        } catch (IOException e) {
//            LogUtils.e( "Could not write icon");
//            return null;
//        }
//    }
