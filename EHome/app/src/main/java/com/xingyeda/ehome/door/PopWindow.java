...
import com.xingyeda.ehome.zhibo.ActivityMyShare;
import com.xingyeda.ehome.zhibo.ActivityShareMain;
import com.xingyeda.ehome.zhibo.ActivityShareSeek;
 ...
 * @date 2016-3-14
 */
@SuppressLint("ViewConstructor") public class PopWindow extends PopupWindow{
	...
	public PopWindow(final Activity context){
		...
		conentView.findViewById(R.id.my_share).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
                BaseUtils.startActivity(mContext, ActivityMyShare.class);
